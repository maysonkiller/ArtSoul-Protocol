        ...
        function renderArtworks(artworks, containerId) {
            ...
            artworks.forEach(art => {
                ...
                if (sharedMedia) {
                    ...
                    video.poster = window.ArtSoulArtworkCard?.brandMediaPoster?.() || '/ARTSOULlogo-clean.png';
                    ...
                    logoImg.src = window.ArtSoulArtworkCard?.brandMediaPoster?.() || '/ARTSOULlogo-clean.png';
                    logoImg.alt = 'Music';
