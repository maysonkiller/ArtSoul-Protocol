...
Phase A1 is not complete yet. The historical testnet migration ledger remains intentionally absent rather than inferred from table names; the authenticated write-path smoke tests and private credential attestations still require operator evidence.
