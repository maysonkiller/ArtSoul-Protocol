...
Phase A stands at **55 done, 13 in progress, 6 planned** across A-01 to A-74. A-47 was reopened on 2026-08-23 by new founder iOS evidence that contradicted browser-only acceptance; its revised preview was accepted on iOS, passed desktop/Android/tablet browser verification and merged as PR #233, while production Android and the legacy-video tail remain open evidence. A-58 was reopened the same day because first visits to profile tabs flashed synthetic cards; its revised iOS preview was accepted, while Android acceptance is still outstanding. A-61 was reopened by a new iOS capture of the large profile avatar partially painted; the already-accepted header path is not implicated. A-50, A-53 and A-56 await a run on a device with a connected wallet; A-51, A-52, A-54, A-55 and A-60 were closed on 2026-08-21 by measurement in a browser. Do not re-open a `done` row without new
