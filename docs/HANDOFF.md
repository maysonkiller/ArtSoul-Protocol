...
| A-54 | Cross-page perceived load | Keep a real profile skeleton visible from the first parsed frame through React hydration, then accept the preview on desktop, iOS and Android. Do not hide the skeleton through the mobile no-motion override. |
