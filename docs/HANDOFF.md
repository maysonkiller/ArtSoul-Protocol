...
Phase A stands at **39 done, 16 in progress, 6 planned** across A-01 to A-61, with
A-52 through A-61 awaiting production acceptance and no open issue. Do not re-open a `done` row without new
